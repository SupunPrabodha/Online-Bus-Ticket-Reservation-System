                ...
                <tbody>
                    <c:forEach var="dr" items="${driverDetails}">
                        <tr>
                            <td>${dr.dname}</td>
                            <td>${dr.phone}</td>
                            <td>${dr.email}</td> <!-- changed 'demail' to 'email' for consistency -->
                            <td>${dr.nic}</td>
                            <td>${dr.username}</td> <!-- changed 'dusername' to 'username' -->
                            <td>${dr.password}</td> <!-- changed 'dpassword' to 'password' -->
                            <td>
                                <!-- Update action -->
                                <a href="updateDriverFormServlet?id=${dr.id}">Update</a> | 
